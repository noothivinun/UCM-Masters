...
function registerListeners(){
    ...
    var img;
        ...
        img.addEventListener( "mouseover",function(){ getContent( "Vinun_Noothi1.html" ); }, false );
        img.addEventListener( "mouseout", clearContent, false );
 
        img = document.getElementById( "two" );
        img.addEventListener( "mouseover", function() { getContent( "Vinun_Noothi2.html" ); }, false );
        img.addEventListener( "mouseout", clearContent, false );
 
        img = document.getElementById( "three" );
        img.addEventListener( "mouseover",function() { getContent( "Vinun_Noothi3.html" ); }, false );
        img.addEventListener( "mouseout", clearContent, false );
