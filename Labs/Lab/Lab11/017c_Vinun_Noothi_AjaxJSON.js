...
function start(){
    ...
    document.getElementById( "Vinun1" ).addEventListener("click", function() { getPictures( "Vinun1.json" ); }, false );
    document.getElementById( "Vinun2" ).addEventListener("click", function() { getPictures( "Vinun2.json" ); }, false );
    document.getElementById( "Vinun3" ).addEventListener("click", function() { getPictures( "Vinun3.json" ); }, false );
