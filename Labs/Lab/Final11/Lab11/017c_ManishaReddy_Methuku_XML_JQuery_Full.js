...
function registerListner(){
    ...
    document.getElementById( "Manisha1" ).addEventListener("click", function() { getImages( "Manisha1.xml" ); }, false );
    document.getElementById( "Manisha2" ).addEventListener("click", function() { getImages( "Manisha2.xml" ); }, false );
    document.getElementById( "Manisha3" ).addEventListener("click", function() { getImages( "Manisha3.xml" ); }, false );
